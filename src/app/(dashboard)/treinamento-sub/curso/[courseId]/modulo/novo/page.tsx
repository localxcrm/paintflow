...
export default function NovoModuloPage({ params }: PageProps) {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-slate-900">Novo Modulo de Treinamento</h1>
          <p className="text-slate-500">Crie um novo modulo para subcontratados</p>
        </div>
