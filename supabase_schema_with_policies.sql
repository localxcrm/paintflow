-- PaintPro Database Schema for Supabase with RLS Policies
-- This version disables RLS for simplicity (good for private apps with custom auth)
...
-- Since we're using custom authentication with service role key,
-- we'll disable RLS for all tables to allow our API full access
-- ============================================
...
ALTER TABLE "Estimate" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "EstimateLineItem" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "EstimateSignature" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "Job" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "RoomPrice" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "ExteriorPrice" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "Addon" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "VTO" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "Rock" DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE "ScorecardMetric" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "ScorecardEntry" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "PeopleAnalyzer" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "CompanyEstimateSettings" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "PortfolioImage" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "AIConversation" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "AIMessage" DISABLE ROW LEVEL SECURITY;
